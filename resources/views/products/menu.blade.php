            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    @foreach ($desserts as $dessert)
                        <div class="pricing-entry d-flex ftco-animate">
                            <div class="img"
                                style="background-image: url({{ asset('assets/images/' . $dessert->images . '') }});"></div>
                            <div class="desc pl-3">
                ...
                <div class="col-md-6">
                    ...
                    @foreach ($drinks as $drink)
                        <div class="pricing-entry d-flex ftco-animate">
                            <div class="img"
                                style="background-image: url({{ asset('assets/images/' . $drink->images . '') }});"></div>
                            <div class="desc pl-3">
                                <div class="d-flex text align-items-center">
                                            ...
                                            <div class="col-md-4 text-center">
                                                <div class="menu-wrap">
                                                    <a href="{{ route('product.single', $drink->id) }}"
                                                        ...
                                                        style="background-image: url({{ asset('assets/images/' . $drink->images . '') }});"></a>
                                                    <div class="text">
                                                        <h3><a
                                        ...
                                        <div class="col-md-4 text-center">
                                            <div class="menu-wrap">
                                                <a href="{{ route('product.single', $dessert->id) }}" class="menu-img img mb-4"
                                                    style="background-image: url({{ asset('assets/images/' . $dessert->images . '') }});"></a>
                                                <div class="text">
