        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 mb-5 ftco-animate">
                    <a href="{{ asset('assets/images/' . $product->images . '') }}" class="image-popup"><img
                            src="{{ asset('assets/images/' . $product->images . '') }}" class="img-fluid"
                    ...
                    <div class="col-md-3">
                        <div class="menu-entry">
                            <a href="{{ route('product.single', $relatedProduct->id) }}" class="img"
                                style="background-image: url({{ asset('assets/images/' . $relatedProduct->images . '') }});"></a>
